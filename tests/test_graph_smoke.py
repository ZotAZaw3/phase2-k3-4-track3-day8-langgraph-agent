...
pytestmark = [
    ...
    pytest.mark.skipif(
        ...
        reason="No LLM API key configured (set GEMINI/OPENAI/ANTHROPIC_API_KEY)",
    ),
]

# ruff: noqa: E402 - imported after pytestmark so the skip marks apply when deps are absent
